...
function App() {
  ...
  const { register, handleSubmit, watch, formState: { errors } } = useForm({ // react-hook-form hook 사용
    mode: 'onSubmit', // default: onSubmit, 최초 검증 시점
    reValidateMode: 'onBlur', // default: onChange, 재검증 시점
    criteriaMode: 'firstError', // default: firstError, errors 객체에 첫 오류 하나만 포함하거나 전부 포함하거나 
    defaultValues: { // 초기값으로 사용할 객체와 그 속성의 초기값
      name: '',
      email: '',
      cellphone: '010',
    }
